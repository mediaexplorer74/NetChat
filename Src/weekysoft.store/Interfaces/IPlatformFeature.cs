...
// Type: weekysoft.store.Interfaces.IPlatformFeature
...
namespace weekysoft.store.Interfaces
{
  ...
  {
    IIPAddressManager IPManager { get; set; }

    ITextToSpeech TextToSpeech { get; set; }

    IRateApp RateApp { get; set; }

    ILocalSetting LocalSetting { get; set; }
  }
}
