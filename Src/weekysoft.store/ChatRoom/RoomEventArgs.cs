...
// Type: weekysoft.store.ChatRoom.RoomEventArgs
...
namespace weekysoft.store.ChatRoom
{
  ...
  {
    public RoomEventArgs(Room room, MemberAction action)
    {
      this.ActiveMember = room;
      this.Action = action;
    }

    public Room ActiveMember { get; private set; }
