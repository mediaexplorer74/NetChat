...
String^ FBCursors::After::get()
{
    return _after;
}
void FBCursors::After::set(String^ value)
{
    _after = value;
...
String^ FBCursors::Before::get()
{
    return _before;
}
void FBCursors::Before::set(String^ value)
{
    _before = value;
